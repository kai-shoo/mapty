...
class Workout {
  ...
  constructor(coords, distance, duration) {
    ...
    this.distance = distance; //minutes
    this.duration = duration; //kilometers
  }
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert('Нет доступа к вашему местоположению');
        }
      );
    }
  }
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Введите положительные числа');

      workout = new Running([lat, lng], distance, duration, cadence);
    }
    // if cycling createa cycling object
    ...
    let html = `
      <li class="workout workout--${workout.type}" data-id="${workout.id}">
        ...
        <div class="workout__details">
          ...
          <span class="workout__value">${workout.duration}4</span>
